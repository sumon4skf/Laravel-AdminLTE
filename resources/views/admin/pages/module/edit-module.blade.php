            ...
            <div class="col-md-7">
                ...
                <div class="box box-info">
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-sm-9">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="moduleName" value="{{ $module->name ?? old('moduleName')}}"
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="description" class="form-control" id="description" rows="4" placeholder="About module...">{{ $module->discription ?? old("description")}}</textarea>
                            ...
                            <div class="col-sm-3" style="margin-top: 5px;">
                                <div class="form-group ">
                                    <label for="customFile" id="customFile" data-input="thumbnail" data-preview="holder" title="Select Image">
                                        <img src="{{asset($module->picture ??'img/no-image.png')}}" title="Module picture" id="holder" class="img-responsive user-picture">
                                    </label>
                        ...
                        <div class="form-group">
                            <input type="submit" class="btn btn-green" value="Update" name="submitbtn" title="Updated">
                            <a href="{{ url("module/{$module->id}/edit") }}" class="btn btn-danger">Reset</a>
                        </div>
