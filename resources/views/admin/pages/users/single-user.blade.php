        ...
        <div class="col-md-3">
            ...
            <div class="box box-primary">
                <div class="box-body box-profile">
                    <img class="profile-user-img img-responsive img-circle"
                        src="{{asset($user->picture)}}" alt="User profile picture">

                    <h3 class="profile-username text-center">{{ "{$user->firstName} {$user->LastName}"}}</h3>

                    <p class="text-muted text-center">{{ $user->role_id}} Software Engineer</p>
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <strong><i class="fa fa-mars-stroke"></i></i> Gender : </strong>
                    <span class="text-muted">
                        {{ "{$user->gender}" }}
                    </span>
                    <hr>

                    <strong><i class="fa fa-envelope"></i></i> Email : </strong>
                    <span class="text-muted">
                    ...
                    <div class="active tab-pane" id="activity">
                        ...
                        <div class="post">
                            <div class="user-block">
                                <img class="img-circle img-bordered-sm" src="{{asset($user->picture)}}" alt="user image">
                                <span class="username">
