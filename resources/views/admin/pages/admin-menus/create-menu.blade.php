...
@section('page-title', "Register new admin menu")
            ...
            <div class="col-md-8">
                ...
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">Create new admin menu</h3>
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <input type="text" name="routeAction" value="{{old('routeAction')}}" class="form-control"
            ...
            <div class="col-sm-4">
                <div class="box box-info">
                    ...
                    <div class="box-body">
                        ...
                        <p class="text-muted">
                            Menu name is the visible name of the menu. we can modify Menu name in anytime. Menu name must be a relevend name.
                        </p>
                        <hr>
                        ...
                        <p class="text-muted">
                            Route URL Laravel Routing URL. You can set only the name of the Route URL. Example <b>something/{id}/edit</b>
                        </p>
                        <hr>
                        <strong><i class="fa fa-book margin-r-5"></i> Route Action</strong>
                        <p class="text-muted">
                            Route Action is the Laravel Route Action. You can set Route action controller. Example <b>Controller@method</b>
                        </p>
                        <hr>
                    </div> <!-- /.box-body -->
                </div> <!-- /.box -->
