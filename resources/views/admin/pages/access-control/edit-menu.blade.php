...
@section('page-title', "Edit admin menu")
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <input type="text" name="menuNameBn" value="{{$menu->nameBn}}" class="form-control"
                            ...
                            <div class="form-group col-sm-12">
                                <input type="submit" class="btn btn-green" value="Update" name="submitbtn"
                                    title="Update">
                                <a href="{{ url("admin-menu/{$menu->id}/edit") }}" class="btn btn-danger"
