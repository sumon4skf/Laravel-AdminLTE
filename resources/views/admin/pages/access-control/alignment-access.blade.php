...
@section('page-title', "Alignment settings")
...
<section class="content">
    ...
    <form action="{{ url("save-alignment") }}" method="POST">
        @csrf
        <div class="row">
            <div class="col-md-12">
                <!-- Form Element sizes -->
...
<script>
    $(function () {
        ...
        function default_load(){
            ...
            $.ajax({
                type: 'POST',
                url: '{{ url('findMenuAlignmentMenu') }}',
                data: {'menuId': 0, 'menuDepth' : menuDepth},
        ...
        $(document).on("click", "#menu1 li", function(){
            ...
            $.ajax({
                type: 'POST',
                url: '{{ url('findMenuAlignmentMenu') }}',
                data: {'menuId': menuId, 'menuDepth' : menuDepth},
                success: function(data) {
                    $("#menu2").html(data);
                },
            });
