...
@section('title', 'Clone frontent menu')

@section('page-title', "Clone front menu")
            ...
            <div class="col-md-8">
                ...
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">Clone front menu</h3>
                    </div>
                    <div class="box-body">
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-12">
                                <input type="submit" class="btn btn-green" value="Save clone" name="submitbtn"
                                    title="Clone">
                                <a href="{{ url("front-menu/{$menu->id}/clone") }}" class="btn btn-danger"
