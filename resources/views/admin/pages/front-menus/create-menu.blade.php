        ...
        <div class="col-md-8">
            ...
            <div class="box box-info">
                <div class="box-header with-border">
                    ...
                    <a href="{{ url("front-menu") }}" class="nav-link">show all</a>
                </div>
                <div class="box-body">
                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    <input type="text" name="menuIcon" value="{{old('menuIcon')}}" class="form-control"
                                ...
                                <div class="form-group col-sm-12">
                                    <label class="radio-inline">
                                        <input type="radio" name="selectURL" value="appUrl" id="appUrl" checked>
                                        App URL
                                    </label>
                                    <label class="radio-inline">
                                ...
                                <div id="customAppURL">
                                    <div class="form-group col-sm-6">
                                        ...
                                        <input type="text" name="routeUrl" value="{{old('routeUrl')}}"
                                            class="form-control" id="routeUrl" placeholder="Route URL">
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    <select name="menuParent" id="menuParent" class="form-control longoption">
                                        ...
                                        <option value="{{$parent->id}}">{{"$parent->id. $parent->name"}}
                                        </option>
                                        @empty
                                        <option value="0">none</option>
                                        @endforelse
