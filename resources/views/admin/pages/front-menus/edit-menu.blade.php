...
@section('title', 'Edit Front menu')

@section('page-title', "Edit Front menu")
...
<section class="content">
    ...
    <form action="{{ url("front-menu/{$menu->id}") }}" method="POST">
        @csrf @method("PUT")
        <div class="row">
            <div class="col-md-8">
                <!-- Form Element sizes -->
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">Edit front menu</h3>
                    </div>
                    <div class="box-body">
                        <div class="row">
                            <div class="form-group col-sm-12">
                                <label class="checkbox-inline">
                                    <input type="checkbox" name="active" value="1"
                                        {{ $menu->active == 1 ? 'checked' : ''}}> Active
                                </label>
                                <label class="checkbox-inline">
                                    <input type="checkbox" name="visible" value="1"
                                        {{ $menu->visibility == 1 ? 'checked' : ''}}> Visible
                                </label>
                            </div>
                        </div> <!-- /.row -->
                        <div class="row">
                            ...
                            <div class="form-group col-sm-12">
                                <label class="radio-inline">
                                    <input type="radio" name="selectURL" value="appUrl" id="appUrl"
                                        {{$menu->preferUrl == "appUrl" ? "checked" : ''}}> App URL
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" name="selectURL" value="customUrl" id="customUrl"
                                        {{$menu->preferUrl == "customUrl" ? "checked" : ''}}> Custom URL
                                </label>
                            </div>

                            <div id="customAppURL" class="{{$menu->preferUrl == "appUrl" ? "" : "hidden" }}">
                                <div class="form-group col-sm-6">
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    <input type="text" name="routeAction" value="{{$menu->routeAction}}"
                            ...
                            <div id="customMenuURL" class="{{$menu->preferUrl == "customUrl" ? "" : "hidden"}}">
                                <div class="form-group col-sm-12">
                                    <label for="custom">Custom URL</label>
                                    <input type="text" name="custom" value="{{$menu->customUrl}}" class="form-control"
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <select name="menuParent" id="menuParent" class="form-control longoption">
                                    ...
                                    <option value="{{$menu->parent_id}}">
                                        {{ $menu->parent_id.". ".$menu->ParentMenu['name']}}</option>
                                    @endif
                            ...
                            <div class="form-group col-sm-12">
                                <input type="submit" class="btn btn-green" value="Update" name="submitbtn"
                                    title="Update">
                                <a href="{{ url("front-menu/{$menu->id}/edit") }}" class="btn btn-danger"
            ...
            <div class="col-sm-4">
                <div class="box box-info">
                    ...
                    <div class="box-body">
                        ...
                        <hr>
                        <strong><i class="fa fa-book margin-r-5"></i> Menu Icon (Font awesome)</strong>
                        <p class="text-muted">
                            It is optional, If you want to set a icon for the menu you just write the font-awesome icon class in this field
                        </p>
                        <hr>
